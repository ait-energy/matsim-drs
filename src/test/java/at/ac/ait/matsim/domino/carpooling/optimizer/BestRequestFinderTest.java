...
class BestRequestFinderTest {
    ...
    CarpoolingRequest driverRequest = new CarpoolingRequest(Id.create(1, Request.class),null,null,8*60*60,null,network.getLinks().get(Id.createLinkId(683)),network.getLinks().get(Id.createLinkId(1851)));
    CarpoolingRequest request2 = new CarpoolingRequest(Id.create(2, Request.class),null,null,8*60*60,null,network.getLinks().get(Id.createLinkId(683)),network.getLinks().get(Id.createLinkId(1852)));
    ...
    CarpoolingRequest request3 = new CarpoolingRequest(Id.create(3, Request.class),null,null,11*60*60,null,network.getLinks().get(Id.createLinkId(683)),network.getLinks().get(Id.createLinkId(216)));
    ...
    CarpoolingRequest request4 = new CarpoolingRequest(Id.create(4, Request.class),null,null,7*60*60,null,network.getLinks().get(Id.createLinkId(683)),network.getLinks().get(Id.createLinkId(976)));
    ...
    CarpoolingRequest request5 = new CarpoolingRequest(Id.create(5, Request.class),null,null,8*60*60,null,network.getLinks().get(Id.createLinkId(683)),network.getLinks().get(Id.createLinkId(90)));
